...
const App = () => {
  const apiKey = ""; // Klíč doplňuje prostředí
  ...
  // --- SUB-KOMPONENTY ---
  const PricingCard = ({ title, price, description, features, gradient, isPremium }) => (
  ...
  const WorkspaceStatCard = ({ label, value, icon: Icon }) => (
